...
export const ProductPage: React.FC<PageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="glass-card rounded-2xl p-6 sm:p-8 text-center space-y-4 max-w-2xl mx-auto border-sky-500/20">
        <div className="inline-flex p-3 rounded-2xl bg-sky-500/10 text-sky-400">
          <ShieldCheck className="w-8 h-8" />
        </div>
        <h3 className="text-xl font-bold text-white">Ready to streamline your business?</h3>
        <p className="text-xs text-slate-400">Experience all desktop & companion mobile capabilities during your 35-day trial.</p>
        <div className="pt-2">
          <Button
            variant="primary"
            size="md"
