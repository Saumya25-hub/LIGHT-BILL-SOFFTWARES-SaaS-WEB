  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {/* Windows Desktop */}
        <Card variant="glow" padding="lg" className="flex flex-col justify-between border-sky-500/30">
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-white">Windows 64-bit Desktop</h3>
            ...
            <div className="space-y-2 text-xs text-slate-300 pt-2 border-t border-white/10">
              <div className="flex justify-between py-1 border-b border-white/5">
                ...
                <span className="font-mono text-white">v{siteConfig.download.desktop.version}</span>
              </div>
              <div className="flex justify-between py-1 border-b border-white/5">
                <span className="text-slate-400">Package Size:</span>
                <span className="font-mono text-white">{siteConfig.download.desktop.fileSizeFormatted}</span>
              </div>
              <div className="flex justify-between py-1 border-b border-white/5">
                <span className="text-slate-400">System Compatibility:</span>
                <span className="text-white">{siteConfig.download.desktop.osSupport}</span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-slate-400">Trial Period:</span>
                <span className="text-emerald-400 font-semibold">35 Days Free</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2 text-xs text-slate-300 pt-2 border-t border-white/10">
              <div className="flex justify-between py-1 border-b border-white/5">
                ...
                <span className="text-cyan-400 font-medium">100% Read-Only Sync</span>
              </div>
              <div className="flex justify-between py-1 border-b border-white/5">
                <span className="text-slate-400">Security:</span>
                <span className="text-white">4-Digit PIN & Biometrics</span>
              </div>
              <div className="flex justify-between py-1 border-b border-white/5">
                <span className="text-slate-400">Cloud Sync:</span>
                <span className="text-white">Private Google Drive</span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-slate-400">Distribution:</span>
                <span className="text-amber-400 font-medium">Google Play Store (In Review)</span>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-3xl mx-auto p-4 rounded-xl bg-navy-900/50 border border-white/10 text-xs text-slate-400 flex items-center gap-3">
