    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <Card variant="hoverable" padding="lg" className="space-y-4">
          ...
          <div className="pt-2">
            <a
              ...
              className="text-sm font-mono text-sky-700 hover:text-sky-800 font-semibold"
            >
        ...
        <Card variant="hoverable" padding="lg" className="space-y-4">
          ...
          <div className="pt-2">
            <a
              ...
              className="text-sm font-mono text-emerald-700 hover:text-emerald-800 font-semibold"
            >
      ...
      <Card variant="subtle" padding="lg" className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-slate-900 text-sm font-semibold">Operating Hours</h4>
            <p className="text-xs text-slate-600">{siteConfig.contact.hours}</p>
          </div>
        </div>
